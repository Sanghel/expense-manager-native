...
- **`main`**: Rama de producción
  ...
  - Deploy a TestFlight / Play Store vía EAS (configuración en FASE 7)
...
# Levantar Expo y probar en simulador
npm start
# Luego pulsar 'i' (iOS) o 'a' (Android)
```

Verificar que la app levanta sin errores y los flujos clave funcionan en simulador.
...
### npm (contexto Expo / React Native)

```bash
npm install               # Instalar dependencias
npm start                 # Expo dev server
npm run ios               # Levantar simulador iOS
npm run android           # Levantar simulador Android
